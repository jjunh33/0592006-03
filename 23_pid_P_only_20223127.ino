...
#define _EMA_ALPHA 0.4      // EMA weight of new sample (range: 0 to 1)                          // Setting EMA to 1 effectively disables EMA filter.

// Servo adjustment
#define _DUTY_NEU 1150  // Servo angle: 0 degree
...
// PID parameters
#define _KP  3.9// proportional gain 1. 4.1
...
{
  return 457 + 0.0939 * a_value - 0.0087 * pow(a_value, 2) + 0.0000217 * pow(a_value, 3) - 0.0000000157 * pow(a_value, 4);// Replace this with the equation obtained from nonlinear regression analysis
}
